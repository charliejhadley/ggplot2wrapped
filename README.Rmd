...
We therefore **explicitly include geoms with an allowlist** to be included in the analysis. Earlier there was a default argument used that we didn't mention:
