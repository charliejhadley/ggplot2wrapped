...
<span class="report-title">Your year in {ggplot2}!</span>

::: {.grid} 

::: {.g-col-12 .g-col-md-6}
Welcome to your year in {ggplot2} this is an interactive look at your favourite visualisation tool (at least in R).

This report was built using the [{ggplot2wrapped}](https://charliejhadley.github.io/ggplot2wrapped/) package created by [Charlotte Hadley](https://www.linkedin.com/in/charliejhadley/) from GPCDS. 

> **Scroll on down** to visualise your visualisation of visualisations!
