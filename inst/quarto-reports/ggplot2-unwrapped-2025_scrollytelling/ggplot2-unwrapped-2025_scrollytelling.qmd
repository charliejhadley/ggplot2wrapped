...
if (params$executed_from == "direct_from_file") {
  load(system.file("quarto", "ggplot2wrapped-2025","data_example_geom_usage.RData", package = "ggplot2wrapped"))
...
#| fig-width: 6
#| fig.height: 6
# make_geom_usage_pies_highcharts(data_summary_geom_calls, )
